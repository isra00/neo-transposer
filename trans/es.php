...
return array(
	...
	=> 'Neo-Transposer cambia de dirección: <strong><a href="http://%domain%">%domain%</a></strong>',

	'If you have a bookmark, please update it.<br>This address will not work after November 6<sup>th</sup>.'
	=> 'Si usas un marcador (favorito), por favor actualízalo.<br>Esta dirección dejará de funcionar el 6 de noviembre.',
