...
<div class="inside">
	...
	<p>You already know that Neo-Transposer transposes the <a href="https://neocatechumenaleiter.org/en/evangelization/#cantos">songs of the Way</a> for your voice, or in a technical language, for your voice range. Voice range means all the notes that you are able to sing, from the lowest to the highest.</p>
	...
	<p class="center"><img src="{{ request()->getBasePath() }}/static/img/perfect-key-pc.en.gif" alt="Ideally, the perfect key for a song is the intersection of the most comfortable key for the singer, the most comfortable key for the people and the key that best reflects the song's intention." /></p>
