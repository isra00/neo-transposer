...
use NeoTransposerApp\Domain\Repository;
...
class AdminMetricsReader
{
    ...
    public function __construct(Repository\AdminMetricsRepository $adminMetricsRepository, Repository\BookRepository $bookRepository, \NeoTransposerApp\Domain\GeoIp\GeoIpResolver $geoIpResolver)
    {
