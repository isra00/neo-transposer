...
final class AdminMetricsReader
{
    ...
    public function __construct(protected Repository\AdminMetricsRepository $adminMetricsRepository, private readonly Repository\BookRepository $bookRepository, protected GeoIpResolver $geoIpResolver)
    {
    }
