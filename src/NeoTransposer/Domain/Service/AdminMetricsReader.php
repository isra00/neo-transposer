...
final class AdminMetricsReader
{
    ...
    public function __construct(protected Repository\AdminMetricsRepository $adminMetricsRepository, private readonly Repository\BookRepository $bookRepository)
    {
    }
    ...
    public function readAdminMetrics(bool $longReports): array
    {
        ...
        return [
            ...
            'perf_by_country'		=> $this->adminMetricsRepository->readPerformanceByCountry(),
